...
import { Space, Table, Tag, Popconfirm, Avatar, Tooltip, Popover, AutoComplete } from 'antd';
...
function ProjectManagement() {
                    ...
                    <tbody>
                      {record.members?.map((member) => (
                        <tr key={member.userId}>
                          ...
                          <td>{member.name}</td>
                          <td>
                            <Avatar className="d-flex align-items-center justify-content-center" src={member.avatar} />
                          </td>
                          <td>
                            <button
  ...
  return (
    <div className="container">
      <h3 className="mt-5">Projects management</h3>
